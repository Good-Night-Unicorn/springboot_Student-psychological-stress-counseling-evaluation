...
var centerMenu = [
    ...
    ,{
        name: '心理健康收藏',
        url: '../xinlijiankangCollection/list.html'
    }
    ,{
        name: '心理健康留言',
        url: '../xinlijiankangLiuyan/list.html'
    }
    ,{
        name: '咨询师预约',
        url: '../zhixunshiYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '心理健康',
        url: './pages/xinlijiankang/list.html'
    },
    {
        name: '咨询师',
        url: './pages/zhixunshi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xinliyalizixunpingpan/admin/dist/index.html#/login";
