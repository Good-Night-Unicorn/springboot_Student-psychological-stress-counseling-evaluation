...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: transparent url("http://codegen.caihongy.cn/20220122/1f1630c36a214ff183847b2fdf9c322b.png") no-repeat top !important;
		...
		&>.el-menu-item {
			...
			border-style: solid;
			border-color: rgba(109, 109, 148, 1) !important;
			background-color: rgba(255,255,255,1) !important;
			box-shadow: 0 0px 0px 0px #6D6D94;
			box-sizing: initial;
			display: flex;
			align-items: center;
