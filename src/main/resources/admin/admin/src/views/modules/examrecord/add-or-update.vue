    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="心理测评表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" placeholder="请选择心理测评表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="心理测评名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="心理测评名称" clearable  :readonly="ro.exampaperName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="心理测评时长(分钟)" prop="exampaperDate">
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="心理测评时长(分钟)" clearable  :readonly="ro.exampaperDate" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="心理测评总分数" prop="exampaperMyscore">
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="心理测评总分数" clearable  :readonly="ro.exampaperMyscore" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="心理测评编号" prop="examrecordUuidNumber">
                        <el-input v-model="ruleForm.examrecordUuidNumber"
                                  placeholder="心理测评编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="心理测评编号" prop="examrecordUuidNumber">
                            <el-input v-model="ruleForm.examrecordUuidNumber"
                                      placeholder="心理测评编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    examrecordUuidNumber: [
                        { required: true, message: '心理测评编号不能为空', trigger: 'blur' },
                    ],
                    yonghuId: [
                        { required: true, message: '心理测评用户不能为空', trigger: 'blur' },
                    ],
                    exampaperId: [
                        { required: true, message: '所属心理测评id（外键）不能为空', trigger: 'blur' },
                    ],
                    totalScore: [
                        { required: true, message: '所得总分不能为空', trigger: 'blur' },
                    ],
                    insertTime: [
                        { required: true, message: '心理测评时间不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
