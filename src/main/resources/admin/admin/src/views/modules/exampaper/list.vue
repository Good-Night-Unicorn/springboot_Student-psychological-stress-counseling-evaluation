        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '心理测评名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.exampaperName" placeholder="心理测评名称" clearable></el-input>
                    </el-form-item>


                    <el-form-item :label="contents.inputTitle == 1 ? '心理测评状态' : ''">
                        <el-select v-model="searchForm.exampaperTypes" placeholder="请选择心理测评状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/testkaoshixiangmu/upload/exampaperMuBan.xls"
                        >批量导入心理测评表数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('exampaper','导入导出')"
...
<!--                            <el-button v-if="isAuth('exampaper','心理测评') && scope.row.exampaperTypes==1" type="primary" icon="el-icon-edit" size="mini" @click="saveExamrecord(scope.row.id)">{{ contents.tableBtnFont == 1?'心理测评':'' }}</el-button>-->
                            ...
                            <el-button v-if="isAuth('exampaper','添加题目')" type="primary" icon="el-icon-edit" size="mini" @click="addKaoti(scope.row)">设置题目</el-button>
