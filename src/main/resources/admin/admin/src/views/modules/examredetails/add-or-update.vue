<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="心理测评编号" prop="examredetailsUuidNumber">
                        <el-input v-model="ruleForm.examredetailsUuidNumber"
                                  placeholder="心理测评编号" clearable  :readonly="ro.examredetailsUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="心理测评编号" prop="examredetailsUuidNumber">
                            <el-input v-model="ruleForm.examredetailsUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="题目表" prop="examquestionId">
                        <el-select v-model="ruleForm.examquestionId" placeholder="请选择题目表" @change="examquestionChange">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题目名称" prop="examquestionName">
                        <el-input v-model="examquestionForm.examquestionName"
                                  placeholder="题目名称" clearable  :readonly="ro.examquestionName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题目排序" prop="examquestionSequence">
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="题目排序，值越大排越前面" clearable  :readonly="ro.examquestionSequence" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题目排序" prop="examquestionSequence">
                            <el-input v-model="ruleForm.examquestionSequence"
                                      placeholder="题目排序，" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题目得分" prop="examredetailsMyscore">
                        <el-input v-model="ruleForm.examredetailsMyscore"
                                  placeholder="题目得分" clearable  :readonly="ro.examredetailsMyscore"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题目得分" prop="examredetailsMyscore">
                            <el-input v-model="ruleForm.examredetailsMyscore"
                                      placeholder="题目得分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    examredetailsMyscore: [
                        { required: true, message: '题目得分不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
