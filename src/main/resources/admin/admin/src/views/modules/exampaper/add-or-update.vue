                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="心理测评名称" prop="exampaperName">
                        <el-input v-model="ruleForm.exampaperName"
                                  placeholder="心理测评名称" clearable :readonly="ro.exampaperName"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="心理测评名称" prop="exampaperName">
                            <el-input v-model="ruleForm.exampaperName"
                                      placeholder="心理测评名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="心理测评时长(分钟)" prop="exampaperDate">
                        <el-input v-model="ruleForm.exampaperDate"
                                  placeholder="心理测评时长(分钟)" clearable :readonly="ro.exampaperDate"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="心理测评时长(分钟)" prop="exampaperDate">
                            <el-input v-model="ruleForm.exampaperDate"
                                      placeholder="心理测评时长(分钟)" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="心理测评总分数" prop="exampaperMyscore">
                        <el-input v-model="ruleForm.exampaperMyscore"
                                  placeholder="心理测评总分数" clearable :readonly="ro.exampaperMyscore"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="心理测评总分数" prop="exampaperMyscore">
                            <el-input v-model="ruleForm.exampaperMyscore"
                                      placeholder="心理测评总分数" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="组题方式" prop="zujuanTypes">
                        <el-select v-model="ruleForm.zujuanTypes" :disabled="ro.zujuanTypes" placeholder="请选择组题方式">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="组题方式" prop="zujuanValue">
                            <el-input v-model="ruleForm.zujuanValue"
                                      placeholder="组题方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="心理测评状态" prop="exampaperTypes">
                        <el-select v-model="ruleForm.exampaperTypes" :disabled="ro.exampaperTypes"
                                   placeholder="请选择心理测评状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="心理测评状态" prop="exampaperValue">
                            <el-input v-model="ruleForm.exampaperValue"
                                      placeholder="心理测评状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    exampaperName: [
                        {required: true, message: '心理测评名称不能为空', trigger: 'blur'},
                    ],
                    exampaperDate: [
                        {required: true, message: '心理测评时长(分钟)不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
                    ...
                    exampaperMyscore: [
                        {required: true, message: '心理测评总分数不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
                    ...
                    exampaperTypes: [
                        {required: true, message: '心理测评状态不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
                    ...
                    zujuanTypes: [
                        {required: true, message: '组题方式不能为空', trigger: 'blur'},
                        {
                            pattern: /^[0-9]*$/,
                            message: '只允许输入整数',
                            trigger: 'blur'
